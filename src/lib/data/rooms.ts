...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    images: [
      ...
      '/images/rooms/room-102/img3.jpg',
      '/images/rooms/room-102/img4.jpg',
      '/images/rooms/room-102/img5.jpg',
      '/images/rooms/room-102/img6.jpg',
      '/images/rooms/room-102/img7.jpg',
    ],
    amenities: [
      { vi: 'Điều hòa nhiệt độ', en: 'Air conditioning' },
      { vi: 'WiFi tốc độ cao', en: 'High-speed WiFi' },
  ...
  },
  {
    id: 'room-321',
    number: '321',
    name: { vi: 'Phòng 321', en: 'Room 321' },
    tagline: {
      vi: 'Tầng cao — lối ra sân thượng và tầm nhìn thành phố',
      en: 'Top floor — rooftop access and city views',
    },
    description: {
      vi: 'Phòng 321 nằm ở tầng 3 của SpiceHome chi nhánh 2, mang đến không gian yên tĩnh và riêng tư trên tầng cao. Điểm đặc biệt là lối ra sân thượng ngay tầng phòng — nơi bạn có thể ngồi thư giãn, ngắm hoàng hôn và tận hưởng tầm nhìn toàn cảnh thành phố.\n\nThiết kế hiện đại ấm áp, phù hợp cho cả những chuyến nghỉ dưỡng lẫn công tác.',
      en: 'Room 321 sits on the top floor of SpiceHome Branch 2, offering a quiet and private retreat above the city. The standout feature is direct access to the rooftop terrace on the same floor — perfect for watching sunsets and enjoying panoramic city views.\n\nWarm modern design makes it a comfortable base for both leisure and business stays.',
    },
    floor: 3,
    branch: 2,
    highlights: [
      { vi: 'Lối ra sân thượng', en: 'Rooftop access' },
      { vi: 'View thành phố', en: 'City view' },
      { vi: 'Tầng cao, yên tĩnh', en: 'Top floor, quiet' },
      { vi: 'Tầng 3', en: '3rd floor' },
    ],
    bed: { vi: 'Giường đôi (140x200cm)', en: 'Double bed (140x200cm)' },
    capacity: 2,
    images: [
      '/images/rooms/room-321/main.jpg',
      '/images/rooms/room-321/img2.jpg',
      '/images/rooms/room-321/img3.jpg',
      '/images/rooms/room-321/img4.jpg',
      '/images/rooms/room-321/img5.jpg',
      '/images/rooms/room-321/img6.jpg',
      '/images/rooms/room-321/img7.jpg',
      '/images/rooms/room-321/img8.jpg',
      '/images/rooms/room-321/img9.jpg',
      '/images/rooms/room-321/img10.jpg',
      '/images/rooms/room-321/img11.jpg',
      '/images/rooms/room-321/img12.jpg',
      '/images/rooms/room-321/img13.jpg',
      '/images/rooms/room-321/img14.jpg',
      '/images/rooms/room-321/img15.jpg',
      '/images/rooms/room-321/img16.jpg',
    ],
    amenities: [
      { vi: 'Điều hòa nhiệt độ', en: 'Air conditioning' },
      { vi: 'WiFi tốc độ cao', en: 'High-speed WiFi' },
    ...
    featured: true,
    calendarSources: [
      { type: 'ical', id: 'https://calendar.google.com/calendar/ical/avrsp3oabtdfbe52vag7t7m6p32hsgrf%40import.calendar.google.com/public/basic.ics' },
